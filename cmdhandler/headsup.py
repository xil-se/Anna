class headsup:
    def __init__(self,event):
        ...
        self.event=event
        event.register_help('headsup','highlights all users in the room','usage: !headsup Your message')

    def muc_headsup(self,msg):
        '''
        Takes a message object as input and will generate a response that includes all the nicknames
        in the MUC.
        '''
        cmd=msg[0]
        msg=msg[1]
